import{_ as d}from"./ContentWrap.vue_vue_type_script_setup_true_lang-ytEdI6w6.js";import{_ as u,u as f}from"./useCesium-BXhUlb7Q.js";import{l as g,m as _,S as h,R as y,q as p,O as b,u as s}from"./vue-chunks-DuYwYYUM.js";import"./index-C3b06j3A.js";import"./element-plus-t0Lc7SBq.js";/* empty css                  */const v={class:"w-[100%] h-[100%]"},I=g({name:"ModifyMap",__name:"ModifyMap",setup(C){const{mapRegister:c,mapMethods:M}=f(),l=(a,e)=>{const t=a.imageryLayers.get(0);t.brightness=e.brightness||.6,t.contrast=e.contrast||1.8,t.gamma=e.gamma||.3,t.hue=e.hue||1,t.saturation=e.saturation||0;const o=a.scene.globe._surfaceShaderSet.baseFragmentShaderSource.sources;for(let r=0;r<o.length;r++){const n=`color = czm_saturation(color, textureSaturation);
#endif
...
//# sourceMappingURL=ModifyMap-De78XhCH.js.map
