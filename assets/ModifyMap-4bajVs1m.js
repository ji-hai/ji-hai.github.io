import{_ as d}from"./ContentWrap.vue_vue_type_script_setup_true_lang-DXMj_k4I.js";import{_ as u,u as f}from"./useCesium-BVJiPYa5.js";import{l as g,m as h,S as _,R as y,q as p,O as v,u as s}from"./vue-chunks-DuYwYYUM.js";import"./index-DrTOaMr6.js";import"./element-plus-t0Lc7SBq.js";/* empty css                  */const b={class:"h-[calc(100vh-280px)]"},I=g({name:"ModifyMap",__name:"ModifyMap",setup(C){const{mapRegister:c,mapMethods:M}=f(),l=(a,e)=>{const t=a.imageryLayers.get(0);t.brightness=e.brightness||.6,t.contrast=e.contrast||1.8,t.gamma=e.gamma||.3,t.hue=e.hue||1,t.saturation=e.saturation||0;const o=a.scene.globe._surfaceShaderSet.baseFragmentShaderSource.sources;for(let r=0;r<o.length;r++){const n=`color = czm_saturation(color, textureSaturation);
#endif
...
//# sourceMappingURL=ModifyMap-4bajVs1m.js.map
